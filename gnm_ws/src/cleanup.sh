...
tasks=(
    ...
    "Delete deploy config file|${r}deploy/config/navigate.yaml"
    "Delete model weights|${r}deploy/model_weights/*"
    "Delete train logs|${r}train/logs"
    "Remove diffusion_policy|${r}diffusion_policy/*"
